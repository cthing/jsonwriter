...
```kotlin
implementation("org.cthing:jsonwriter:2.1.0")
```
...
writer.startObject()
      ...
      .value(true)             // Value
      .endObject();
writer.flush();                // Good practice when the default constructor is used
```
JSON written:
```json
{
...
- In a browser, go to the project on [GitHub](https://github.com/cthing/jsonwriter)
